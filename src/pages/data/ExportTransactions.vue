      ...
      <q-card-section>
        <div class="row q-col-gutter-md">
          ...
          <div class="col-xs-6 col-sm-3">
            <q-select v-model="groupBy" :options="['none', 'day', 'week', 'month', 'year']" label="Group By" outlined
              dense />
          </div>
        ...
        <q-table :rows="previewData" :columns="selectedColumns" flat dense bordered virtual-scroll row-key="id" />
      </q-card-section>
